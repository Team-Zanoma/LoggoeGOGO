...
import './components/VideoPlayerComponent/VideoPlayerComponent.css'

import ReactPlayer from 'react-player';
import Duration from './components/VideoPlayerComponent/Duration.jsx'
    ...
    return (
      <div className='app'>
        <section className='section'>
          ...
          <div>{ Math.floor(duration * played) }</div>
          <table><tbody>
            <tr>
              <th>Controls</th>
              <td>
